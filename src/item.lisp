...
(defun create-drop-item-list (lst)
  (sort (loop :for i :in lst
	   :append (reverse (drop-list i)))
	#'>= :key #'cdr))


(defparameter *sword-drop-rate-list*  nil)
(defparameter *armor-drop-rate-list* nil)
...
(defun init-item-drop-rate-list ()
  (setf *sword-drop-rate-list* (create-drop-item-list (list *sword-list*))
	*armor-drop-rate-list* (create-drop-item-list (list *shield-list*))))
...
(defparameter *weapondescs*
  ...
  (make-array +w_max+
	      :initial-contents
	      (list
	       (make-instance 'weapondesc :categoly :sword :name "木刀" :damage 1 :atktype :atk
		 :hit 90 :critical 10 :rangemin 1 :rangemax 1 :price 50)
	       (make-instance 'weapondesc :categoly :sword :name "ナイフ" :damage 2 :atktype :atk
		 :hit 100 :critical 15 :rangemin 1 :rangemax 1 :price 100)
	       (make-instance 'weapondesc :categoly :sword :name "ダガー" :damage 3 :atktype :atk
		 :hit 100 :critical 15 :rangemin 1 :rangemax 1 :price 150)
	       (make-instance 'weapondesc :categoly :sword :name "銀のナイフ" :damage 4 :atktype :atk
		 :hit 100 :critical 15 :rangemin 1 :rangemax 1 :price 150)
	       (make-instance 'weapondesc :categoly :sword :name "鉄の剣" :damage 5 :atktype :atk
		 :hit 90 :critical 10 :rangemin 1 :rangemax 1 :price 320)
	       (make-instance 'weapondesc :categoly :sword :name "古代の剣" :damage 6 :atktype :atk
		 :hit 90 :critical 10 :rangemin 1 :rangemax 1 :price 150)
	       (make-instance 'weapondesc :categoly :sword :name "珊瑚の剣" :damage 7 :atktype :atk
		 :hit 90 :critical 10 :rangemin 1 :rangemax 1 :price 150)
	       (make-instance 'weapondesc :categoly :sword :name "ブロードソード" :damage 8 :atktype :atk
		 :hit 90 :critical 10 :rangemin 1 :rangemax 1 :price 150)
	       (make-instance 'weapondesc :categoly :sword :name "銀の剣" :damage 9 :atktype :atk
		 :hit 90 :critical 10 :rangemin 1 :rangemax 1 :price 2000)
	       (make-instance 'weapondesc :categoly :sword :name "白銀のナイフ" :damage 9 :atktype :atk
		 :hit 100 :critical 15 :rangemin 1 :rangemax 1 :price 150)
	       (make-instance 'weapondesc :categoly :sword :name "炎の剣" :damage 10 :atktype :atk
		 :hit 90 :critical 10 :rangemin 1 :rangemax 1 :price 150)
	       (make-instance 'weapondesc :categoly :sword :name "氷の剣" :damage 11 :atktype :atk
		 :hit 90 :critical 10 :rangemin 1 :rangemax 1 :price 150)
	       (make-instance 'weapondesc :categoly :sword :name "メイジマッシャー" :damage 11 :atktype :atk
		 :hit 100 :critical 15 :rangemin 1 :rangemax 1 :price 150)
	       (make-instance 'weapondesc :categoly :sword :name "白銀の剣" :damage 12 :atktype :atk
		 :hit 90 :critical 10 :rangemin 1 :rangemax 1 :price 150)
	       (make-instance 'weapondesc :categoly :sword :name "石化剣" :damage 13 :atktype :atk
		 :hit 90 :critical 10 :rangemin 1 :rangemax 1 :price 150)
	       (make-instance 'weapondesc :categoly :sword :name "フレイムタン" :damage 14 :atktype :atk
		 :hit 90 :critical 10 :rangemin 1 :rangemax 1 :price 150)
	       (make-instance 'weapondesc :categoly :sword :name "アイスブランド" :damage 15 :atktype :atk
		 :hit 90 :critical 10 :rangemin 1 :rangemax 1 :price 150)
	       (make-instance 'weapondesc :categoly :sword :name "ブラッドソード" :damage 16 :atktype :atk
		 :hit 90 :critical 10 :rangemin 1 :rangemax 1 :price 150)
	       (make-instance 'weapondesc :categoly :sword :name "トリトンダガー" :damage 17 :atktype :atk
		 :hit 100 :critical 15 :rangemin 1 :rangemax 1 :price 150)
	       (make-instance 'weapondesc :categoly :sword :name "ディフェンダー" :damage 18 :atktype :atk
		 :hit 90 :critical 10 :rangemin 1 :rangemax 1 :price 150)
	       (make-instance 'weapondesc :categoly :sword :name "影の剣" :damage 19 :atktype :atk
		 :hit 90 :critical 10 :rangemin 1 :rangemax 1 :price 150)
	       (make-instance 'weapondesc :categoly :sword :name "アサシンダガー" :damage 19 :atktype :atk
		 :hit 100 :critical 20 :rangemin 1 :rangemax 1 :price 150)
	       (make-instance 'weapondesc :categoly :sword :name "死の剣" :damage 20 :atktype :atk
		 :hit 90 :critical 10 :rangemin 1 :rangemax 1 :price 150)
	       (make-instance 'weapondesc :categoly :sword :name "エクスカリバー" :damage 21 :atktype :atk
		 :hit 90 :critical 10 :rangemin 1 :rangemax 1 :price 150)
	       (make-instance 'weapondesc :categoly :sword :name "アポカリプス" :damage 22 :atktype :atk
		 :hit 90 :critical 10 :rangemin 1 :rangemax 1 :price 150)
	       (make-instance 'weapondesc :categoly :sword :name "光の剣" :damage 23 :atktype :atk
		 :hit 90 :critical 10 :rangemin 1 :rangemax 1 :price 150)
	       (make-instance 'weapondesc :categoly :sword :name "ラグナロク" :damage 24 :atktype :atk
		 :hit 90 :critical 10 :rangemin 1 :rangemax 1 :price 150)
	      ...
	      ;;盾
	      (make-instance 'armordesc :categoly :armor :name "皮の盾"       :def 0  :blk  5 :price 30)
	      (make-instance 'armordesc :categoly :armor :name "バックラー"   :def 1  :blk  6 :price 30)
	      (make-instance 'armordesc :categoly :armor :name "鉄の盾"       :def 2  :blk  7 :price 80)
	      (make-instance 'armordesc :categoly :armor :name "大盾"         :def 3  :blk  8 :price 80)
	      (make-instance 'armordesc :categoly :armor :name "銅の盾"       :def 4  :blk  9 :price 80)
	      (make-instance 'armordesc :categoly :armor :name "暗黒の盾"     :def 5  :blk 11 :price 80)
	      (make-instance 'armordesc :categoly :armor :name "銀の盾"       :def 6  :blk 13 :price 80)
	      (make-instance 'armordesc :categoly :armor :name "闇の盾"       :def 7  :blk 15 :price 80)
	      (make-instance 'armordesc :categoly :armor :name "金の盾"       :def 8  :blk 17 :price 80)
	      (make-instance 'armordesc :categoly :armor :name "光の盾"       :def 9  :blk 19 :price 80)
	      (make-instance 'armordesc :categoly :armor :name "白銀の盾"     :def 10 :blk 21 :price 80)
	      (make-instance 'armordesc :categoly :armor :name "炎の盾"       :def 11 :blk 22 :price 80)
	      (make-instance 'armordesc :categoly :armor :name "氷の盾"       :def 12 :blk 23 :price 80)
	      (make-instance 'armordesc :categoly :armor :name "力の盾"       :def 13 :blk 24 :price 80)
	      (make-instance 'armordesc :categoly :armor :name "ダイアの盾"   :def 14 :blk 25 :price 80)
	      (make-instance 'armordesc :categoly :armor :name "イージスの盾" :def 15 :blk 26 :price 80)
	      (make-instance 'armordesc :categoly :armor :name "龍の盾"       :def 16 :blk 27 :price 80)
	      (make-instance 'armordesc :categoly :armor :name "水晶の盾"     :def 17 :blk 28 :price 80)
	      (make-instance 'armordesc :categoly :armor :name "源氏の盾"     :def 18 :blk 29 :price 80)
	      (make-instance 'armordesc :categoly :armor :name "英雄の盾"     :def 20 :blk 30 :price 80)
...
(defun set-test-item-list ()
  ...
  (loop :for weapon :across *weapondescs*
	:collect (shallow-copy-object weapon)))
